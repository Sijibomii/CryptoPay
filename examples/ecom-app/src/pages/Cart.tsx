...
import CryptoPay from "@sijibomi/cryptopay-sdk/src/index"
            ...
            <div className="px-3 md:px-6">
                ...
                <div className="flex flex-col pb-6">
                    ...
                    <div className="text-right flex self-end justify-center items-center mt-3 ">
                        ...
                        <Link className="text-sm ml-2 flex items-center rounded-[5px] p-2 bg-green-500" to="#" onClick={handleCheckOut}>
