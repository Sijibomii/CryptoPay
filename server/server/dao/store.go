...
func CreateStore(e *actor.Engine, conn *actor.PID, ownerId uuid.UUID, name, description string, privateKey types.PrivateKey, publicKey types.PublicKey, Mnemonic, Hd_path string) (*models.Store, error) {
